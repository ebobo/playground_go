...
PowerControllerAttributes_a PowerControllerAttributes_PWR_CTRL_1001 = { 0x00000708, 0xe101 
};

static PowerUnitAttributesId_a PowerUnitAttributesId_PWR_CTRL_1002[1] = {
	{ 0xe001 /* Power */,
	{ 0x00000262   } } 
};

AttributeDirectory_a AttributeDirectory_PWR_CTRL_1000 = {
	&PowerControllerAttributes_PWR_CTRL_1001, 
	1, PowerUnitAttributesId_PWR_CTRL_1002, 
0x00000000, 0x0100101c, 0xfefefefe  
};
...
static UnitId_a UnitId_PWR_CTRL_1008[2] = {
	0xe001 /* Power */, /* (2) */
	0xe101 /* KOLHEIVEGEN 10 */  /* (2) */
};

static IsOperatedByEntry_a IsOperatedByEntry_PWR_CTRL_1007[1] = {
	{ 0xe101 /* KOLHEIVEGEN 10 */,
	2, UnitId_PWR_CTRL_1008  } 
};

static IsOperatedBy_a IsOperatedBy_PWR_CTRL_1004 = {
	1, IsOperatedByEntry_PWR_CTRL_1007  
};
PowerCheckParameters_a	PowerCheckParameters_a_AC_541_2 [2] = 
{
			{
				1 /* POWER_CHECK_1 */,
				0 /* ENABLE */,
				1 /* RELATIVE */,
				60 /* int Time */
			}/* ElementNo 0 UnitNo <1292> UnitName <>  EntityName <Power Check Parameters> */,
			{
				2 /* POWER_CHECK_2 */,
				0 /* ENABLE */,
				0 /* ABSOLUTE */,
				36000 /* int Time */
			}/* ElementNo 0 UnitNo <1293> UnitName <>  EntityName <Power Check Parameters> */
};
PowerCheckScheduleEntry_a	PowerCheckScheduleEntry_a_AC_539_1 [1] = 
{
	{
		57598 /* int UnitId */,
		2 /* int Power Check Parameters Count */,
		PowerCheckParameters_a_AC_541_2 /* Ptr to array of type PowerCheckParameters_a */
	}/* ElementNo 0 UnitNo <1272> UnitName <>  EntityName <Power Check Schedule Entry> */
};


PowerCheckSchedule_a	PowerCheckSchedule_a_AC_538_1 = 
{
	1 /* int Power Check Count */,
	PowerCheckScheduleEntry_a_AC_539_1 /* Ptr to array of type PowerCheckScheduleEntry_a */
};

FaultIndDelayEntry_a FaultIndDelayEntry_PWR_CTRL_1010[2] = {
	{0x0016, 0x070e, 0x0000   },
	{0x0016, 0x0b03, 0x0000   } 
};

static FaultIndDelays_a FaultIndDelays_PWR_CTRL_1009 = {
	2, FaultIndDelayEntry_PWR_CTRL_1010  
};

PowerSCD_Directory_a PowerSCD_Directory_PWR_CTRL_1003 = {
	&FaultClearCondition_a_0, 
	&IsOperatedBy_PWR_CTRL_1004, 
	&PowerCheckSchedule_a_AC_538_1, 
	&FaultIndDelays_PWR_CTRL_1009, 
0x00000000, 0x03f2d2c4, 0xfefefefe  
};


static CompIdUnitId_a CompIdUnitId_PWR_CTRL_1015[1] = {
	{ 0xf801 /* Computer Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_PWR_CTRL_1017[1] = {
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_PWR_CTRL_1018[1] = {
	{ 0xd401 /* BLC_Eq */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_PWR_CTRL_1020[1] = {
	{ 0xf901 /* Power Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_PWR_CTRL_1021[2] = {
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_PWR_CTRL_1024[3] = {
	{ 0xea01 /* FPE Controller */,0xffff  },
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static ACLIB_Object_a ACLIB_Object_PWR_CTRL_1012[12] = {
	{/* COMPONENT_START_UP_ACK_ID */ 0xee8d,
	0, NULL, 
	0, NULL  },
	{/* CONFIGURATION_CRC_CHECK_STATUS_ID */ 0xee95,
	1, CompIdUnitId_PWR_CTRL_1015, 
	0, NULL  },
	{/* POWER_ACK_ID */ 0xf200,
	1, CompIdUnitId_PWR_CTRL_1017, 
	0, NULL  },
	{/* POWER_MON_CMD_ID */ 0xf204,
	1, CompIdUnitId_PWR_CTRL_1020, 
	0, NULL  },
	{/* POWER_STATUS_ID */ 0xf206,
	2, CompIdUnitId_PWR_CTRL_1021, 
	0, NULL  },
	{/* POWER_TEST_ACK_ID */ 0xf208,
	1, CompIdUnitId_PWR_CTRL_1017, 
	0, NULL  },
	{/* POWER_EQ_DEMAND_ID */ 0xf209,
	1, CompIdUnitId_PWR_CTRL_1018, 
	0, NULL  },
	{/* POWER_EQ_CMD_ID */ 0xf240,
	1, CompIdUnitId_PWR_CTRL_1018, 
	0, NULL  },
...
static ComponentAddress_a ComponentAddress_PWR_CTRL_1013[6] = {
	{ 0xd401 /* BLC_Eq */,
	{ 0x0003, 0x01   } },
...
ACLIB_ObjectDirectory_a ACLIB_ObjectDirectory_PWR_CTRL_1011 = {
	6, ComponentAddress_PWR_CTRL_1013, 
	12, ACLIB_Object_PWR_CTRL_1012, 
0x00000000, 0x03f2d718, 0xfefefefe  
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_23 = {
	"ekPOW_CTRL_51830_Router"
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_24 = {
	"Router_ekPOW_CTRL_51830"
};

static AcPortData_a AcPortData_PWR_CTRL_1026[1] = {
	{0x00000001, 0x0a, 
	{ 0x000d, 0x01   },
	4, &AcFifoBinAddr_a_AC_13_23   } 
};

static AcRouteData_a AcRouteData_PWR_CTRL_1027[1] = {
	{0x00000001, 0x0a, 
	{ 0x0000, 0x00   },
	4, &AcFifoBinAddr_a_AC_13_24   } 
};

AcBinaryConfigData_a AcBinaryConfigData_PWR_CTRL_1028 = {
	1, AcPortData_PWR_CTRL_1026, 
	1, AcRouteData_PWR_CTRL_1027, 
0x00000000, 0x03f2d83c, 0xfefefefe  
};

static ComponentDirectory_a ComponentDirectoryPowerController = {
	0xf901,
	&AttributeDirectory_PWR_CTRL_1000,
	&PowerSCD_Directory_PWR_CTRL_1003,
	&ACLIB_ObjectDirectory_PWR_CTRL_1011,
	&AcBinaryConfigData_PWR_CTRL_1028
};
