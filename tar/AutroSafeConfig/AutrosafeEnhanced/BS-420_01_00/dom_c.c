...
DomainNetwControllerAttributes_a DomainNetwControllerAttributes_DOM_CTRL_1001 = { 0x00000708, 0x00000023, 0x0000000a, 0xe101 
};

static DomainNetwUnitAttributesId_a DomainNetwUnitAttributesId_DOM_CTRL_1002[1] = {
	{ 0xd601 /* Domain Network */,
	{ 0x00000262   } } 
};

AttributeDirectory_a AttributeDirectory_DOM_CTRL_1000 = {
	&DomainNetwControllerAttributes_DOM_CTRL_1001, 
	1, DomainNetwUnitAttributesId_DOM_CTRL_1002, 
0x00000000, 0x01000024, 0xfefefefe  
};
...
static UnitId_a UnitId_DOM_CTRL_1008[2] = {
	0xd601 /* Domain Network */, /* (2) */
	0xe101 /* KOLHEIVEGEN 10 */  /* (2) */
};

static IsOperatedByEntry_a IsOperatedByEntry_DOM_CTRL_1007[1] = {
	{ 0xe101 /* KOLHEIVEGEN 10 */,
	2, UnitId_DOM_CTRL_1008  } 
};

static IsOperatedBy_a IsOperatedBy_DOM_CTRL_1004 = {
	1, IsOperatedByEntry_DOM_CTRL_1007  
};

static word16_a word16_DOM_CTRL_1010[1] = {
	0xf801 /* Computer Controller */  /* (2) */
};

static ComputersOnDomainNetwork_a ComputersOnDomainNetwork_DOM_CTRL_1009 = {0xd601, /* Domain Network */
	1, word16_DOM_CTRL_1010  
};
DomainNetwCheckParameters_a	DomainNetwCheckParameters_a_AC_522_1 [1] = 
{
			{
				0 /* DOMAIN_NETW_PING */,
				0 /* ENABLE */,
				1 /* RELATIVE */,
				600 /* int Time */
			}/* ElementNo 0 UnitNo <1788> UnitName <>  EntityName <Domain Netw Check Parameters> */
};
DomainNetwCheckScheduleEntry_a	DomainNetwCheckScheduleEntry_a_AC_520_1 [1] = 
{
	{
		55038 /* int UnitId */,
		1 /* int DomainNetwCheckParametersCount */,
		DomainNetwCheckParameters_a_AC_522_1 /* Ptr to array of type DomainNetwCheckParameters_a */
	}/* ElementNo 0 UnitNo <1409> UnitName <>  EntityName <Domain Netw Check Schedule Entry> */
};


DomainNetwCheckSchedule_a	DomainNetwCheckSchedule_a_AC_519_1 = 
{
	1 /* int DomainNetwCheckScheduleEntryCount */,
	DomainNetwCheckScheduleEntry_a_AC_520_1 /* Ptr to array of type DomainNetwCheckScheduleEntry_a */
};

FaultIndDelayEntry_a FaultIndDelayEntry_DOM_CTRL_1012[2] = {
	{0x0016, 0x070e, 0x0000   },
	{0x0016, 0x0b03, 0x0000   } 
};

static FaultIndDelays_a FaultIndDelays_DOM_CTRL_1011 = {
	2, FaultIndDelayEntry_DOM_CTRL_1012  
};

DomainNetwSCD_Directory_a DomainNetwSCD_Directory_DOM_CTRL_1003 = {
	&FaultClearCondition_a_0, 
	&IsOperatedBy_DOM_CTRL_1004, 
	&ComputersOnDomainNetwork_DOM_CTRL_1009, 
	&DomainNetwCheckSchedule_a_AC_519_1, 
	&FaultIndDelays_DOM_CTRL_1011, 
0x00000000, 0x03f007e8, 0xfefefefe  
};


static CompIdUnitId_a CompIdUnitId_DOM_CTRL_1018[1] = {
	{ 0xf801 /* Computer Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_DOM_CTRL_1019[1] = {
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_DOM_CTRL_1021[2] = {
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_DOM_CTRL_1025[3] = {
	{ 0xea01 /* FPE Controller */,0xffff  },
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static ACLIB_Object_a ACLIB_Object_DOM_CTRL_1014[11] = {
	...
	1, CompIdUnitId_DOM_CTRL_1018, 
	0, NULL  },
	{/* DOMAIN_NETW_ACK_ID */ 0xef80,
	1, CompIdUnitId_DOM_CTRL_1019, 
	0, NULL  },
	{/* DOMAIN_NETW_MON_CMD_ID */ 0xef83,
	0, NULL, 
	0, NULL  },
	{/* DOMAIN_NETW_STATUS_ID */ 0xef85,
	2, CompIdUnitId_DOM_CTRL_1021, 
	0, NULL  },
...
static ComponentAddress_a ComponentAddress_DOM_CTRL_1015[16] = {
	{ 0xd401 /* BLC_Eq */,
	{ 0x0003, 0x01   } },
...
ACLIB_ObjectDirectory_a ACLIB_ObjectDirectory_DOM_CTRL_1013 = {
	16, ComponentAddress_DOM_CTRL_1015, 
	11, ACLIB_Object_DOM_CTRL_1014, 
0x00000000, 0x03f00c48, 0xfefefefe  
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_3 = {
	"ekDOM_CTRL_50374_Router"
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_4 = {
	"Router_ekDOM_CTRL_50374"
};

static AcPortData_a AcPortData_DOM_CTRL_1027[1] = {
	{0x00000001, 0x0a, 
	{ 0x0002, 0x01   },
	4, &AcFifoBinAddr_a_AC_13_3   } 
};

static AcRouteData_a AcRouteData_DOM_CTRL_1028[1] = {
	{0x00000001, 0x0a, 
	{ 0x0000, 0x00   },
	4, &AcFifoBinAddr_a_AC_13_4   } 
};

AcBinaryConfigData_a AcBinaryConfigData_DOM_CTRL_1029 = {
	1, AcPortData_DOM_CTRL_1027, 
	1, AcRouteData_DOM_CTRL_1028, 
0x00000000, 0x03f00d90, 0xfefefefe  
};

static ComponentDirectory_a ComponentDirectoryDomainController = {
	0xe701,
	&AttributeDirectory_DOM_CTRL_1000,
	&DomainNetwSCD_Directory_DOM_CTRL_1003,
	&ACLIB_ObjectDirectory_DOM_CTRL_1013,
	&AcBinaryConfigData_DOM_CTRL_1029
};
