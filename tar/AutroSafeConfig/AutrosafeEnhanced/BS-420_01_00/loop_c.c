...
LoopControllerAttributes_a LoopControllerAttributes_LOOP_CTRL_1001 = { 0x00000708, 0xe101 
};

static LoopUnitAttributesId_a LoopUnitAttributesId_LOOP_CTRL_1002[4] = {
	{ 0xd001 /* BSL 310 */,
	{ 0x00000262, 0x09, 0x00   } },
	{ 0xd002 /* SLØYFE-A1 */,
	{ 0x00000262, 0x02, 0x00   } },
	{ 0xd003 /* SLØYFE-A2 */,
	{ 0x00000262, 0x02, 0x00   } },
	{ 0xd004 /* BSB-310-1 */,
	{ 0x00000262, 0x07, 0x00   } } 
};

AttributeDirectory_a AttributeDirectory_LOOP_CTRL_1000 = {
	&LoopControllerAttributes_LOOP_CTRL_1001, 
	4, LoopUnitAttributesId_LOOP_CTRL_1002, 
0x00000000, 0x01000d80, 0xfefefefe  
};
...
static UnitId_a UnitId_LOOP_CTRL_1008[5] = {
	0xd001 /* BSL 310 */, /* (2) */
	0xd002 /* SLØYFE-A1 */, /* (2) */
	0xd003 /* SLØYFE-A2 */, /* (2) */
	0xd004 /* BSB-310-1 */, /* (2) */
...
static IsOperatedByEntry_a IsOperatedByEntry_LOOP_CTRL_1007[1] = {
	{ 0xe101 /* KOLHEIVEGEN 10 */,
	5, UnitId_LOOP_CTRL_1008  } 
};

static IsOperatedBy_a IsOperatedBy_LOOP_CTRL_1004 = {
	1, IsOperatedByEntry_LOOP_CTRL_1007  
};

static IsCoordinatedBy_a IsCoordinatedBy_LOOP_CTRL_1009 = {
	0, NULL  
};

FaultIndDelayEntry_a FaultIndDelayEntry_LOOP_CTRL_1012[2] = {
	{0x0016, 0x070e, 0x0000   },
	{0x0016, 0x0b03, 0x0000   } 
};

static FaultIndDelays_a FaultIndDelays_LOOP_CTRL_1011 = {
	2, FaultIndDelayEntry_LOOP_CTRL_1012  
};

LoopSCD_Directory_a LoopSCD_Directory_LOOP_CTRL_1003 = {
	&FaultClearCondition_a_0, 
	&IsOperatedBy_LOOP_CTRL_1004, 
	&IsCoordinatedBy_LOOP_CTRL_1009, 
	&FaultIndDelays_LOOP_CTRL_1011, 
0x00000000, 0x03f2b8cc, 0xfefefefe  
};


static CompIdUnitId_a CompIdUnitId_LOOP_CTRL_1017[1] = {
	{ 0xf801 /* Computer Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_LOOP_CTRL_1018[1] = {
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_LOOP_CTRL_1022[1] = {
	{ 0xd401 /* BLC_Eq */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_LOOP_CTRL_1024[2] = {
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_LOOP_CTRL_1028[6] = {
	{ 0xea01 /* FPE Controller */,0xffff  },
	{ 0xec01 /* OP Controller */,0xd001  /* BSL 310 */},
	{ 0xec01 /* OP Controller */,0xd002  /* SLØYFE-A1 */},
	{ 0xec01 /* OP Controller */,0xd003  /* SLØYFE-A2 */},
	{ 0xec01 /* OP Controller */,0xd004  /* BSB-310-1 */},
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static ACLIB_Object_a ACLIB_Object_LOOP_CTRL_1014[14] = {
	{/* LOOP_ACK_ID */ 0xec00,
	1, CompIdUnitId_LOOP_CTRL_1018, 
	0, NULL  },
	{/* LOOP_DIRECT_DATA_ID */ 0xec03,
	0, NULL, 
	0, NULL  },
	{/* LOOP_STATUS_ID */ 0xec06,
	2, CompIdUnitId_LOOP_CTRL_1024, 
	0, NULL  },
	{/* LOOP_TEST_ACK_ID */ 0xec08,
	1, CompIdUnitId_LOOP_CTRL_1018, 
	0, NULL  },
	{/* LOOP_CTRL_STATUS_ID */ 0xec21,
	1, CompIdUnitId_LOOP_CTRL_1017, 
	0, NULL  },
	{/* LOOP_CTRL_CMD_ACK_ID */ 0xec22,
	0, NULL, 
	0, NULL  },
	{/* LOOP_EQ_CMD_ID */ 0xec40,
	1, CompIdUnitId_LOOP_CTRL_1022, 
	0, NULL  },
	{/* LOOP_EQ_SERVICE_PERMISSION_ID */ 0xec44,
	1, CompIdUnitId_LOOP_CTRL_1022, 
	0, NULL  },
...
static ComponentAddress_a ComponentAddress_LOOP_CTRL_1015[16] = {
	{ 0xd401 /* BLC_Eq */,
	{ 0x0003, 0x01   } },
...
ACLIB_ObjectDirectory_a ACLIB_ObjectDirectory_LOOP_CTRL_1013 = {
	16, ComponentAddress_LOOP_CTRL_1015, 
	14, ACLIB_Object_LOOP_CTRL_1014, 
0x00000000, 0x03f2bd10, 0xfefefefe  
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_15 = {
	"ekLOOP_CTRL_51826_Router"
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_16 = {
	"Router_ekLOOP_CTRL_51826"
};

static AcPortData_a AcPortData_LOOP_CTRL_1030[1] = {
	{0x00000001, 0x0a, 
	{ 0x0009, 0x01   },
	4, &AcFifoBinAddr_a_AC_13_15   } 
};

static AcRouteData_a AcRouteData_LOOP_CTRL_1031[1] = {
	{0x00000001, 0x0a, 
	{ 0x0000, 0x00   },
	4, &AcFifoBinAddr_a_AC_13_16   } 
};

AcBinaryConfigData_a AcBinaryConfigData_LOOP_CTRL_1032 = {
	1, AcPortData_LOOP_CTRL_1030, 
	1, AcRouteData_LOOP_CTRL_1031, 
0x00000000, 0x03f2be98, 0xfefefefe  
};

static ComponentDirectory_a ComponentDirectoryLoopController = {
	0xef01,
	&AttributeDirectory_LOOP_CTRL_1000,
	&LoopSCD_Directory_LOOP_CTRL_1003,
	&ACLIB_ObjectDirectory_LOOP_CTRL_1013,
	&AcBinaryConfigData_LOOP_CTRL_1032
};
