...
PointControllerAttributes_a PointControllerAttributes_POINT_CTRL_1001 = { 0x00000708, 0x0000032a, 0x0000000a, 0x0000003c, 0x00, 0x00000078, 0xe101 
};

static PointUnitAttributesId_a PointUnitAttributesId_POINT_CTRL_1002[25] = {
	{ 0x0001 /* A1 001 */,
	{ 0x00000262, 0x00, 0x01, 0x01, 0x00   } },
	{ 0x0002 /* A1 003 */,
	{ 0x00000262, 0x02, 0x01, 0x01, 0x00   } },
	{ 0x0003 /* A1 005 */,
	{ 0x00000262, 0x02, 0x01, 0x01, 0x00   } },
	{ 0x0004 /* A1 006 */,
	{ 0x00000262, 0x02, 0x01, 0x01, 0x00   } },
	...
	{ 0x00000262, 0x00, 0x01, 0x01, 0x00   } },
	{ 0x000d /* A2 001 */,
	{ 0x00000262, 0x03, 0x00, 0x01, 0x00   } },
	{ 0x000e /* A2 002 */,
	{ 0x00000262, 0x00, 0x01, 0x01, 0x00   } },
	{ 0x000f /* A2 003 */,
	{ 0x00000262, 0x01, 0x01, 0x01, 0x00   } },
	{ 0x0010 /* A2 004 */,
	{ 0x00000262, 0x01, 0x01, 0x01, 0x00   } },
	{ 0x0011 /* A2 006 */,
	{ 0x00000262, 0x03, 0x00, 0x01, 0x00   } },
	...
	{ 0x00000262, 0x01, 0x01, 0x01, 0x00   } },
	{ 0x0019 /* A2 015 */,
	{ 0x00000262, 0x0d, 0x01, 0x01, 0x00   } } 
};

AttributeDirectory_a AttributeDirectory_POINT_CTRL_1000 = {
	&PointControllerAttributes_POINT_CTRL_1001, 
	25, PointUnitAttributesId_POINT_CTRL_1002, 
0x00000000, 0x01000dd0, 0xfefefefe  
};
...
static UnitId_a UnitId_POINT_CTRL_1008[26] = {
	0x0001 /* A1 001 */, /* (2) */
	0x0002 /* A1 003 */, /* (2) */
	0x0003 /* A1 005 */, /* (2) */
	0x0004 /* A1 006 */, /* (2) */
...
static IsOperatedByEntry_a IsOperatedByEntry_POINT_CTRL_1007[1] = {
	{ 0xe101 /* KOLHEIVEGEN 10 */,
	26, UnitId_POINT_CTRL_1008  } 
};

static IsOperatedBy_a IsOperatedBy_POINT_CTRL_1004 = {
	1, IsOperatedByEntry_POINT_CTRL_1007  
};


AlarmDisableTimeoutStruct_a	AlarmDisableTimeoutStruct_a_0 = 
{
	7200 /* int AlarmDisableTimeout */
};


PointAutoEnableStruct_a	PointAutoEnableStruct_a_0 = 
{
	0 /* char PointAutoEnable */
};

FaultIndDelayEntry_a FaultIndDelayEntry_POINT_CTRL_1010[2] = {
	{0x0016, 0x070e, 0x0000   },
	{0x0016, 0x0b03, 0x0000   } 
};

static FaultIndDelays_a FaultIndDelays_POINT_CTRL_1009 = {
	2, FaultIndDelayEntry_POINT_CTRL_1010  
};

static PointGasProperties_a PointGasProperties_POINT_CTRL_1011 = {
	0, NULL  
};

PointSCD_Directory_a PointSCD_Directory_POINT_CTRL_1003 = {
	&FaultClearCondition_a_0, 
	&IsOperatedBy_POINT_CTRL_1004, 
	&AlarmDisableTimeoutStruct_a_0, 
	&PointAutoEnableStruct_a_0, 
	&FaultIndDelays_POINT_CTRL_1009, 
	&PointGasProperties_POINT_CTRL_1011, 
0x00000000, 0x03f2bed4, 0xfefefefe  
};


static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1017[1] = {
	{ 0xf801 /* Computer Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1018[1] = {
	{ 0xd401 /* BLC_Eq */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1020[1] = {
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1021[1] = {
	{ 0xec01 /* OP Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1025[3] = {
	{ 0xec01 /* OP Controller */,0x5ffe  },
	{ 0xec01 /* OP Controller */,0xd801  /* OP (Operator Panel) */},
	{ 0xec01 /* OP Controller */,0xd802  /* REMOTE PILOT */} 
};

static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1026[3] = {
	{ 0xe801 /* DZ Controller */,0xffff  },
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1030[28] = {
	{ 0xe801 /* DZ Controller */,0x0001  /* A1 001 */},
	{ 0xe801 /* DZ Controller */,0x0002  /* A1 003 */},
	{ 0xe801 /* DZ Controller */,0x0003  /* A1 005 */},
	{ 0xe801 /* DZ Controller */,0x0004  /* A1 006 */},
	{ 0xe801 /* DZ Controller */,0x0005  /* A1 007 */},
	{ 0xe801 /* DZ Controller */,0x0006  /* A1 009 */},
	{ 0xe801 /* DZ Controller */,0x0007  /* A1 011 */},
	{ 0xe801 /* DZ Controller */,0x0008  /* A1 013 */},
	{ 0xe801 /* DZ Controller */,0x0009  /* A1 015 */},
	{ 0xe801 /* DZ Controller */,0x000a  /* A1 016 */},
	{ 0xe801 /* DZ Controller */,0x000b  /* A1 017 */},
	{ 0xe801 /* DZ Controller */,0x000c  /* A1 019 */},
	{ 0xe801 /* DZ Controller */,0x000d  /* A2 001 */},
	{ 0xe801 /* DZ Controller */,0x000e  /* A2 002 */},
	{ 0xe801 /* DZ Controller */,0x000f  /* A2 003 */},
	{ 0xe801 /* DZ Controller */,0x0010  /* A2 004 */},
	{ 0xe801 /* DZ Controller */,0x0011  /* A2 006 */},
	{ 0xe801 /* DZ Controller */,0x0012  /* A2 007 */},
	{ 0xe801 /* DZ Controller */,0x0013  /* A2 008 */},
	{ 0xe801 /* DZ Controller */,0x0014  /* A2 009 */},
	{ 0xe801 /* DZ Controller */,0x0015  /* A2 010 */},
	{ 0xe801 /* DZ Controller */,0x0016  /* A2 012 */},
	{ 0xe801 /* DZ Controller */,0x0017  /* A2 013 */},
	{ 0xe801 /* DZ Controller */,0x0018  /* A2 014 */},
	{ 0xe801 /* DZ Controller */,0x0019  /* A2 015 */},
	{ 0xea01 /* FPE Controller */,0xffff  },
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_POINT_CTRL_1031[1] = {
	{ 0xfb01 /* OZ Controller */,0xffff  } 
};

static ACLIB_Object_a ACLIB_Object_POINT_CTRL_1014[17] = {
	{/* POINT_ACK_ID */ 0x8000,
	1, CompIdUnitId_POINT_CTRL_1020, 
	0, NULL  },
	{/* POINT_STATUS_ID */ 0x8005,
	3, CompIdUnitId_POINT_CTRL_1026, 
	0, NULL  },
	{/* POINT_TEST_ACK_ID */ 0x8007,
	1, CompIdUnitId_POINT_CTRL_1020, 
	0, NULL  },
	{/* POINT_PMRV_ID */ 0x8008,
	3, CompIdUnitId_POINT_CTRL_1025, 
	0, NULL  },
	{/* POINT_SV_STATUS_ID */ 0x8009,
	1, CompIdUnitId_POINT_CTRL_1021, 
	0, NULL  },
	{/* POINT_CTRL_STATUS_ID */ 0x8020,
	1, CompIdUnitId_POINT_CTRL_1021, 
	0, NULL  },
	{/* POINT_EQ_CMD_ID */ 0x8040,
	1, CompIdUnitId_POINT_CTRL_1018, 
	0, NULL  },
	{/* POINT_EQ_DEMAND_ID */ 0x8041,
	1, CompIdUnitId_POINT_CTRL_1018, 
	0, NULL  },
	{/* OP_ZONE_EQ_CMD_ID */ 0xee60,
	1, CompIdUnitId_POINT_CTRL_1018, 
	0, NULL  },
	...
	1, CompIdUnitId_POINT_CTRL_1017, 
	0, NULL  },
	...
	28, CompIdUnitId_POINT_CTRL_1030, 
	0, NULL  },
	{/* UNIT_FAULT_ACCEPT_CMD_ACK_ID */ 0xfc04,
	0, NULL, 
	0, NULL  },
	{/* UNIT_OZ_FAULT_COUNT_STATUS_ID */ 0xfc05,
	1, CompIdUnitId_POINT_CTRL_1031, 
	0, NULL  } 
};

static ComponentAddress_a ComponentAddress_POINT_CTRL_1015[7] = {
	{ 0xd401 /* BLC_Eq */,
	{ 0x0003, 0x01   } },
...
ACLIB_ObjectDirectory_a ACLIB_ObjectDirectory_POINT_CTRL_1013 = {
	7, ComponentAddress_POINT_CTRL_1015, 
	17, ACLIB_Object_POINT_CTRL_1014, 
0x00000000, 0x03f2c358, 0xfefefefe  
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_17 = {
	"ekPOINT_CTRL_51827_Router"
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_18 = {
	"Router_ekPOINT_CTRL_51827"
};

static AcPortData_a AcPortData_POINT_CTRL_1033[1] = {
	{0x00000001, 0x0a, 
	{ 0x000a, 0x01   },
	4, &AcFifoBinAddr_a_AC_13_17   } 
};

static AcRouteData_a AcRouteData_POINT_CTRL_1034[1] = {
	{0x00000001, 0x0a, 
	{ 0x0000, 0x00   },
	4, &AcFifoBinAddr_a_AC_13_18   } 
};

AcBinaryConfigData_a AcBinaryConfigData_POINT_CTRL_1035 = {
	1, AcPortData_POINT_CTRL_1033, 
	1, AcRouteData_POINT_CTRL_1034, 
0x00000000, 0x03f2c54c, 0xfefefefe  
};

static ComponentDirectory_a ComponentDirectoryPointController = {
	0xee01,
	&AttributeDirectory_POINT_CTRL_1000,
	&PointSCD_Directory_POINT_CTRL_1003,
	&ACLIB_ObjectDirectory_POINT_CTRL_1013,
	&AcBinaryConfigData_POINT_CTRL_1035
};
