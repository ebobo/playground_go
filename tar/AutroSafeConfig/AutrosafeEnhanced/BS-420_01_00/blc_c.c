...
BLC_ControllerAttributes_a BLC_ControllerAttributes_BLC_CTRL_1001 = { 0x00000708, 0xe101 
};

static BLC_UnitAttributesId_a BLC_UnitAttributesId_BLC_CTRL_1002[1] = {
	{ 0xd401 /* BLC_Eq */ } 
};

AttributeDirectory_a AttributeDirectory_BLC_CTRL_1000 = {
	&BLC_ControllerAttributes_BLC_CTRL_1001, 
	1, BLC_UnitAttributesId_BLC_CTRL_1002, 
0x00000000, 0x01000c40, 0xfefefefe  
};
...
static UnitId_a UnitId_BLC_CTRL_1008[2] = {
	0xd401 /* BLC_Eq */, /* (2) */
	0xe101 /* KOLHEIVEGEN 10 */  /* (2) */
};

static IsOperatedByEntry_a IsOperatedByEntry_BLC_CTRL_1007[1] = {
	{ 0xe101 /* KOLHEIVEGEN 10 */,
	2, UnitId_BLC_CTRL_1008  } 
};

static IsOperatedBy_a IsOperatedBy_BLC_CTRL_1004 = {
	1, IsOperatedByEntry_BLC_CTRL_1007  
};

FaultIndDelayEntry_a FaultIndDelayEntry_BLC_CTRL_1010[2] = {
	{0x0016, 0x070e, 0x0000   },
	{0x0016, 0x0b03, 0x0000   } 
};

static FaultIndDelays_a FaultIndDelays_BLC_CTRL_1009 = {
	2, FaultIndDelayEntry_BLC_CTRL_1010  
};

BLC_SCD_Directory_a BLC_SCD_Directory_BLC_CTRL_1003 = {
	&FaultClearCondition_a_0, 
	&IsOperatedBy_BLC_CTRL_1004, 
	&FaultIndDelays_BLC_CTRL_1009, 
0x00000000, 0x03f01158, 0xfefefefe  
};


static CompIdUnitId_a CompIdUnitId_BLC_CTRL_1014[1] = {
	{ 0xd401 /* BLC_Eq */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_BLC_CTRL_1015[2] = {
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_BLC_CTRL_1017[1] = {
	{ 0xf801 /* Computer Controller */,0xffff  } 
};

static CompIdUnitId_a CompIdUnitId_BLC_CTRL_1020[3] = {
	{ 0xea01 /* FPE Controller */,0xffff  },
	{ 0xec01 /* OP Controller */,0xffff  },
	{ 0xf601 /* Log Controller */,0xffff  } 
};

static ACLIB_Object_a ACLIB_Object_BLC_CTRL_1012[7] = {
	{/* BLC_STATUS_ID */ 0xee04,
	2, CompIdUnitId_BLC_CTRL_1015, 
	0, NULL  },
	{/* BLC_EQ_CMD_ID */ 0xee40,
	1, CompIdUnitId_BLC_CTRL_1014, 
	0, NULL  },
	{/* COMPONENT_START_UP_ACK_ID */ 0xee8d,
	0, NULL, 
	0, NULL  },
	{/* CONFIGURATION_CRC_CHECK_STATUS_ID */ 0xee95,
	1, CompIdUnitId_BLC_CTRL_1017, 
	0, NULL  },
	{/* OZ_CMD_ACK_ID */ 0xf302,
	0, NULL, 
	0, NULL  },
	{/* UNIT_FAULT_STATUS_ID */ 0xfc01,
	3, CompIdUnitId_BLC_CTRL_1020, 
	0, NULL  },
...
static ComponentAddress_a ComponentAddress_BLC_CTRL_1013[5] = {
	{ 0xd401 /* BLC_Eq */,
	{ 0x0003, 0x01   } },
...
ACLIB_ObjectDirectory_a ACLIB_ObjectDirectory_BLC_CTRL_1011 = {
	5, ComponentAddress_BLC_CTRL_1013, 
	7, ACLIB_Object_BLC_CTRL_1012, 
0x00000000, 0x03f01584, 0xfefefefe  
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_7 = {
	"ekBLC_EQ_CTRL_50381_Router"
};

AcFifoBinAddr_a AcFifoBinAddr_a_AC_13_8 = {
	"Router_ekBLC_EQ_CTRL_50381"
};

static AcPortData_a AcPortData_BLC_CTRL_1021[1] = {
	{0x00000001, 0x0a, 
	{ 0x0004, 0x01   },
	4, &AcFifoBinAddr_a_AC_13_7   } 
};

static AcRouteData_a AcRouteData_BLC_CTRL_1022[1] = {
	{0x00000001, 0x0a, 
	{ 0x0000, 0x00   },
	4, &AcFifoBinAddr_a_AC_13_8   } 
};

AcBinaryConfigData_a AcBinaryConfigData_BLC_CTRL_1023 = {
	1, AcPortData_BLC_CTRL_1021, 
	1, AcRouteData_BLC_CTRL_1022, 
0x00000000, 0x03f0164c, 0xfefefefe  
};

static ComponentDirectory_a ComponentDirectoryBLCController = {
	0xf001,
	&AttributeDirectory_BLC_CTRL_1000,
	&BLC_SCD_Directory_BLC_CTRL_1003,
	&ACLIB_ObjectDirectory_BLC_CTRL_1011,
	&AcBinaryConfigData_BLC_CTRL_1023
};
